    ...
    <div className="main-content">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--sp3)', marginBottom: 'var(--sp3)' }}>
        ...
        <div className="card">
          ...
          {[
            ...
            {
              label: 'Assigned Rep',
              value: customer.assigned_salesperson ? `${customer.assigned_salesperson.name} (${customer.assigned_salesperson.email})` : 'Unassigned',
            },
            {
              label: 'Follow-up',
      ...
      <div className="card">
        ...
        {!customer.customer_notes?.length ? (
          <EmptyState title="No notes yet" message="Add a follow-up note above to start the timeline." />
        ) : (
